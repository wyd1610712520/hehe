...
- (BOOL)addContactName:(NSString*)name phoneNum:(NSString*)num withLabel:(NSString*)label email:(NSString*)emailString address:(NSString*)address fox:(NSString*)fox code:(NSString*)code{
...
//    ABRecordSetValue(record, kABPersonPhoneProperty, multi, &error);
    ...
    bool didAddEmail = ABMultiValueAddValueAndLabel(emailMultiValue, (__bridge CFTypeRef)emailString, (__bridge CFTypeRef)@"邮箱", NULL);
    if(didAddEmail){
        ABRecordSetValue(record, kABPersonEmailProperty, emailMultiValue, nil);
    }
    CFRelease(emailMultiValue);
    
    ABMultiValueRef phone =ABMultiValueCreateMutable(kABMultiStringPropertyType);
    ABMultiValueAddValueAndLabel(phone,fox,(__bridge CFTypeRef)@"传真", NULL);
    ABMultiValueAddValueAndLabel(phone,fox,(__bridge CFTypeRef)@"电话", NULL);
    ABMultiValueAddValueAndLabel(phone,num,(__bridge CFTypeRef)@"手机", NULL);
    ABRecordSetValue(record, kABPersonPhoneProperty, phone, NULL);

    
//    ABMutableMultiValueRef mobileValue = ABMultiValueCreateMutable(kABPersonJobTitleProperty);
//    bool didPhone = ABMultiValueAddValueAndLabel(mobileValue, (__bridge CFTypeRef)(fox), (__bridge CFTypeRef)@"电话", NULL);
//    if(didPhone){
//        ABRecordSetValue(record, kABPersonJobTitleProperty, mobileValue,nil);
//    }
//    CFRelease(mobileValue);


//    ABMutableMultiValueRef foxPhone = ABMultiValueCreateMutable(kABPersonDepartmentProperty);
//    bool didAddfox = ABMultiValueAddValueAndLabel(foxPhone, (__bridge CFTypeRef)(fox), (__bridge CFTypeRef)@"传真", NULL);
//    if(didAddfox){
//        ABRecordSetValue(record, kABPersonDepartmentProperty, foxPhone,nil);
//    }
//    CFRelease(foxPhone);
    
//    ABMutableMultiValueRef codePhone = ABMultiValueCreateMutable(kABMultiStringPropertyType);
//    bool didAddcode = ABMultiValueAddValueAndLabel(codePhone, (__bridge CFTypeRef)(code), (__bridge CFTypeRef)@"邮编", NULL);
//    if(didAddcode){
//        ABRecordSetValue(record, kABPersonPhoneProperty, codePhone,nil);
//    }
//    CFRelease(codePhone);

    
    ////////
//    ABMutableMultiValueRef addressMultiValue = ABMultiValueCreateMutable(kABPersonAddressProperty);
//    
//    bool didAddaddress = ABMultiValueAddValueAndLabel(addressMultiValue, (__bridge CFTypeRef)address, (__bridge CFTypeRef)kABOtherLabel, NULL);
//    
//    if(didAddaddress){
//        
//        ABRecordSetValue(record, kABPersonAddressProperty, addressMultiValue, nil);
//        
//    }
//    CFRelease(addressMultiValue);
    ...
    [addressDictionary setObject:address forKey:(NSString *)kABPersonAddressCityKey];
    ABMultiValueAddValueAndLabel(multiAddress, addressDictionary, (__bridge CFTypeRef)@"地址", NULL);
